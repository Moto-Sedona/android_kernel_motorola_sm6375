...
#define CHARGING_PAUSE_CMD_REG			0x1043
				  ...
				  const union power_supply_propval *pval)
{
	...
	case POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT_MAX:
		...
		rc = sm7250_write(bms->pmic_regmap,
					CHGR_FAST_CHARGE_CURRENT_CFG_REG,
					&val, 1);
